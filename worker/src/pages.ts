...
<div style="text-align:center;margin-top:24px;padding:24px;background:#0d0d18;border:1px solid #1a1a2a;border-radius:12px;max-width:720px;margin-left:auto;margin-right:auto">
  <h3 style="margin-top:0;font-size:.95rem">🛡️ MetaDefender Reports</h3>
  <p style="font-size:.78rem;color:#555;margin-bottom:16px">Independent scan reports for each binary. Click to view full results.</p>
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:6px;text-align:left">
<a href="https://metadefender.opswat.com/results/#!/file/0a889f2446bd0dd86e25b0e1a0dad54fa72a35e89045733b6a220483cbaedcff/regular/overview" target="_blank" rel="noopener" style="display:flex;align-items:center;justify-content:space-between;padding:5px 8px;border-radius:4px;font-size:.72rem;font-family:monospace;color:#8b5cf6;border:1px solid #1a1a2a;transition:all .15s" onmouseover="this.style.borderColor='#8b5cf6';this.style.background='#12102a'" onmouseout="this.style.borderColor='#1a1a2a';this.style.background='transparent'"><span>Windows Installer</span><span style="color:#555">0a889f2446bd…</span></a>
<a href="https://metadefender.opswat.com/results/#!/file/774c7898eadb7bfb76b65ff7fb590108e86446018e108505761e9a76d542d1cc/regular/overview" target="_blank" rel="noopener" style="display:flex;align-items:center;justify-content:space-between;padding:5px 8px;border-radius:4px;font-size:.72rem;font-family:monospace;color:#8b5cf6;border:1px solid #1a1a2a;transition:all .15s" onmouseover="this.style.borderColor='#8b5cf6';this.style.background='#12102a'" onmouseout="this.style.borderColor='#1a1a2a';this.style.background='transparent'"><span>Windows MSI</span><span style="color:#555">774c7898eadb…</span></a>
<a href="https://metadefender.opswat.com/results/#!/file/517fdf8db7401abee9ae99046588f67ddd279d6959594bf135bc005bb6724f62/regular/overview" target="_blank" rel="noopener" style="display:flex;align-items:center;justify-content:space-between;padding:5px 8px;border-radius:4px;font-size:.72rem;font-family:monospace;color:#8b5cf6;border:1px solid #1a1a2a;transition:all .15s" onmouseover="this.style.borderColor='#8b5cf6';this.style.background='#12102a'" onmouseout="this.style.borderColor='#1a1a2a';this.style.background='transparent'"><span>macOS Apple Silicon</span><span style="color:#555">517fdf8db740…</span></a>
<a href="https://metadefender.opswat.com/results/#!/file/60902ac2633a6df94488743a04d484a364b249bfafcdd7933dcc9210f1628e87/regular/overview" target="_blank" rel="noopener" style="display:flex;align-items:center;justify-content:space-between;padding:5px 8px;border-radius:4px;font-size:.72rem;font-family:monospace;color:#8b5cf6;border:1px solid #1a1a2a;transition:all .15s" onmouseover="this.style.borderColor='#8b5cf6';this.style.background='#12102a'" onmouseout="this.style.borderColor='#1a1a2a';this.style.background='transparent'"><span>macOS Intel</span><span style="color:#555">60902ac2633a…</span></a>
<a href="https://metadefender.opswat.com/results/#!/file/54ea3d6118cb78efe56fa8381a0fe5a6b072f8295d879b1123b2243555d6a2c6/regular/overview" target="_blank" rel="noopener" style="display:flex;align-items:center;justify-content:space-between;padding:5px 8px;border-radius:4px;font-size:.72rem;font-family:monospace;color:#8b5cf6;border:1px solid #1a1a2a;transition:all .15s" onmouseover="this.style.borderColor='#8b5cf6';this.style.background='#12102a'" onmouseout="this.style.borderColor='#1a1a2a';this.style.background='transparent'"><span>Linux .deb</span><span style="color:#555">54ea3d6118cb…</span></a>
<a href="https://metadefender.opswat.com/results/#!/file/1139f6e52e323ea703b224a0fdb84940eb1b16b6d2a30b9bb0e25214f816328d/regular/overview" target="_blank" rel="noopener" style="display:flex;align-items:center;justify-content:space-between;padding:5px 8px;border-radius:4px;font-size:.72rem;font-family:monospace;color:#8b5cf6;border:1px solid #1a1a2a;transition:all .15s" onmouseover="this.style.borderColor='#8b5cf6';this.style.background='#12102a'" onmouseout="this.style.borderColor='#1a1a2a';this.style.background='transparent'"><span>Linux AppImage</span><span style="color:#555">1139f6e52e32…</span></a>
<a href="https://metadefender.opswat.com/results/#!/file/c664ca959e4ce8b5b25dc75a4dfd77386192da70ba6c859b00e3bc90ab60e474/regular/overview" target="_blank" rel="noopener" style="display:flex;align-items:center;justify-content:space-between;padding:5px 8px;border-radius:4px;font-size:.72rem;font-family:monospace;color:#8b5cf6;border:1px solid #1a1a2a;transition:all .15s" onmouseover="this.style.borderColor='#8b5cf6';this.style.background='#12102a'" onmouseout="this.style.borderColor='#1a1a2a';this.style.background='transparent'"><span>Linux .rpm</span><span style="color:#555">c664ca959e4c…</span></a>
<a href="https://metadefender.opswat.com/results/#!/file/c0b93f0856fd7d5cb79870c9ac42c0f236658956acb0d288ff4d880b80c18b72/regular/overview" target="_blank" rel="noopener" style="display:flex;align-items:center;justify-content:space-between;padding:5px 8px;border-radius:4px;font-size:.72rem;font-family:monospace;color:#8b5cf6;border:1px solid #1a1a2a;transition:all .15s" onmouseover="this.style.borderColor='#8b5cf6';this.style.background='#12102a'" onmouseout="this.style.borderColor='#1a1a2a';this.style.background='transparent'"><span>macOS ARM .tar.gz</span><span style="color:#555">c0b93f0856fd…</span></a>
<a href="https://metadefender.opswat.com/results/#!/file/87de02b17f5751daca52945cfa99c4e913a1f1b3cc3a20d6754d9df84456a199/regular/overview" target="_blank" rel="noopener" style="display:flex;align-items:center;justify-content:space-between;padding:5px 8px;border-radius:4px;font-size:.72rem;font-family:monospace;color:#8b5cf6;border:1px solid #1a1a2a;transition:all .15s" onmouseover="this.style.borderColor='#8b5cf6';this.style.background='#12102a'" onmouseout="this.style.borderColor='#1a1a2a';this.style.background='transparent'"><span>macOS Intel .tar.gz</span><span style="color:#555">87de02b17f57…</span></a>
</div>
  <p style="margin-top:12px;font-size:.68rem;color:#555">Scanned via <a href="https://metadefender.com" target="_blank" rel="noopener" style="color:#8b5cf6">MetaDefender Cloud</a></p>
</div>
