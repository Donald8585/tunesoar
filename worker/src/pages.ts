...
<div style="text-align:center;margin-top:24px;padding:24px;background:#0d0d18;border:1px solid #1a1a2a;border-radius:12px;max-width:720px;margin-left:auto;margin-right:auto">
  <h3 style="margin-top:0;font-size:.95rem">🛡️ MetaDefender Cloud — All Clean</h3>
  <p style="font-size:.78rem;color:#555;margin-bottom:8px">Scanned by <b style="color:#22c55e">21 engines</b> · <b style="color:#22c55e">0 detections</b> across all binaries</p>
  <div style="display:inline-flex;align-items:center;gap:6px;padding:6px 16px;border-radius:20px;background:#052e16;border:1px solid #166534;margin-bottom:16px">
    <span style="font-size:.85rem;color:#22c55e">✓ Verified Clean</span>
  </div>
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:6px;text-align:left"><div style="display:flex;align-items:center;justify-content:space-between;padding:5px 8px;border-radius:4px;font-size:.72rem;font-family:monospace;color:#8a8a9a;border:1px solid #1a1a2a"><span>Windows Installer</span><span style="color:#22c55e">0/21 · 0a889f2…</span></div>
<div style="display:flex;align-items:center;justify-content:space-between;padding:5px 8px;border-radius:4px;font-size:.72rem;font-family:monospace;color:#8a8a9a;border:1px solid #1a1a2a"><span>Windows MSI</span><span style="color:#22c55e">0/21 · 774c789…</span></div>
<div style="display:flex;align-items:center;justify-content:space-between;padding:5px 8px;border-radius:4px;font-size:.72rem;font-family:monospace;color:#8a8a9a;border:1px solid #1a1a2a"><span>macOS Apple Silicon</span><span style="color:#22c55e">0/21 · 517fdf8…</span></div>
<div style="display:flex;align-items:center;justify-content:space-between;padding:5px 8px;border-radius:4px;font-size:.72rem;font-family:monospace;color:#8a8a9a;border:1px solid #1a1a2a"><span>macOS Intel</span><span style="color:#22c55e">0/21 · 60902ac…</span></div>
<div style="display:flex;align-items:center;justify-content:space-between;padding:5px 8px;border-radius:4px;font-size:.72rem;font-family:monospace;color:#8a8a9a;border:1px solid #1a1a2a"><span>Linux .deb</span><span style="color:#22c55e">0/21 · 54ea3d6…</span></div>
<div style="display:flex;align-items:center;justify-content:space-between;padding:5px 8px;border-radius:4px;font-size:.72rem;font-family:monospace;color:#8a8a9a;border:1px solid #1a1a2a"><span>Linux AppImage</span><span style="color:#22c55e">0/21 · 1139f6e…</span></div>
<div style="display:flex;align-items:center;justify-content:space-between;padding:5px 8px;border-radius:4px;font-size:.72rem;font-family:monospace;color:#8a8a9a;border:1px solid #1a1a2a"><span>Linux .rpm</span><span style="color:#22c55e">0/21 · c664ca9…</span></div>
<div style="display:flex;align-items:center;justify-content:space-between;padding:5px 8px;border-radius:4px;font-size:.72rem;font-family:monospace;color:#8a8a9a;border:1px solid #1a1a2a"><span>macOS ARM .tar.gz</span><span style="color:#22c55e">0/21 · c0b93f0…</span></div>
<div style="display:flex;align-items:center;justify-content:space-between;padding:5px 8px;border-radius:4px;font-size:.72rem;font-family:monospace;color:#8a8a9a;border:1px solid #1a1a2a"><span>macOS Intel .tar.gz</span><span style="color:#22c55e">0/21 · 87de02b…</span></div>
</div>
  <p style="margin-top:12px;font-size:.68rem;color:#555">Scanned via <a href="https://metadefender.com" target="_blank" rel="noopener" style="color:#8b5cf6">MetaDefender Cloud</a>. Results verified on each release.</p>
</div>
